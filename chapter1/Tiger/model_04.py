...
class Resnet(object):
    ...
    def inference(self):
        ...
        x = resnet_layer(inputs=self.img,
    ...
    def train_one_epoch(self, sess, saver, init, writer, epoch, step):
        ...
        try:
            ...
            pass
        saver.save(sess, 'checkpoints/resnet_v2/resnet_v2_model', step)
    ...
    def train(self, n_epochs):
        ...
        utils.make_dir('checkpoints/resnet_v2')
        writer = tf.summary.FileWriter('./graphs/resnet_v2', tf.get_default_graph())

        with tf.Session() as sess:
            sess.run(tf.global_variables_initializer())
            saver = tf.train.Saver()
            ckpt = tf.train.get_checkpoint_state(os.path.dirname('checkpoints/resnet_v2/checkpoint'))
